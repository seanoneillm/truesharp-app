...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Direct strategy bets:', { directStrategyBets, directStrategyBetsError, count: directStrategyBets?.length });
    ...
    console.log('strategy_bets table:', { strategyBetsTable, strategyBetsTableError, count: strategyBetsTable?.length });
