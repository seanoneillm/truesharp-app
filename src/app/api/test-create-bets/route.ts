  ...
  try {
    ...
    if (testError) {
      ...
      return NextResponse.json({
        ...
        suggestion: 'The user_performance_cache table or trigger functions may be missing from your Supabase database.',
        details: testError
      })
    }
