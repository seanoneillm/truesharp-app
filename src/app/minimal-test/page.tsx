...
export default function MinimalAuthTestPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl p-8">
      <h1 className="mb-4 text-2xl font-bold">Minimal Auth Test</h1>
      ...
      <button
        ...
        disabled={loading}
        className="rounded-lg bg-purple-500 px-6 py-3 text-white hover:bg-purple-600 disabled:opacity-50"
      >
