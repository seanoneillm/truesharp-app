...
const LEAGUE_TAB_STRUCTURE: Record<string, TabStructure> = {
  MLB: {
    ...
    'Player Props': {
      'Hitters': [
        'Hits Over/Under', 'Home Runs Over/Under', 'RBIs Over/Under', 'Runs Scored Over/Under',
        'Total Bases Over/Under', 'Singles Over/Under', 'Doubles Over/Under', 'Triples Over/Under',
        'Stolen Bases Over/Under', 'Strikeouts Over/Under', 'Walks Over/Under', 'Hits + Runs + RBIs Over/Under'
      ],
      'Pitchers': [
        'Strikeouts Over/Under', 'Hits Allowed Over/Under', 'Earned Runs Allowed Over/Under',
        'Walks Allowed Over/Under', 'Home Runs Allowed Over/Under', 'Pitches Thrown Over/Under',
        'Outs Recorded Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Runs Over/Under', 'Team Home Runs Over/Under', 'Team Strikeouts Over/Under',
        'Team Hits Over/Under'
      ]
    },
    'Game Props': {
      'All': [
        'Total Home Runs Over/Under', 'Total Strikeouts Over/Under', 'Total Hits Over/Under',
        'Runs Even/Odd', 'Home Runs Even/Odd'
      ]
    }
  },
  NFL: {
    ...
    'Player Props': {
      'Quarterback': [
        'Passing Yards Over/Under', 'Passing Touchdowns Over/Under', 'Interceptions Over/Under',
        'Completions Over/Under', 'Passing Attempts Over/Under', 'Longest Completion Over/Under',
        'Rushing Yards Over/Under', 'Rushing Touchdowns Over/Under', 'Passing + Rushing Yards Over/Under',
        'Passer Rating Over/Under'
      ],
      'Running Back': [
        'Rushing Yards Over/Under', 'Rushing Touchdowns Over/Under', 'Rushing Attempts Over/Under',
        'Receptions Over/Under', 'Receiving Yards Over/Under', 'Receiving Touchdowns Over/Under',
        'Longest Rush Over/Under', 'Rushing + Receiving Yards Over/Under'
      ],
      'Wide Receiver': [
        'Receiving Yards Over/Under', 'Receptions Over/Under', 'Receiving Touchdowns Over/Under',
        'Longest Reception Over/Under', 'Rushing Yards Over/Under', 'Rushing Touchdowns Over/Under'
      ],
      'Kicker/Defense': [
        'Kicking Points Over/Under', 'Field Goals Made Over/Under', 'Extra Points Made Over/Under',
        'Longest Field Goal Over/Under', 'Sacks Over/Under', 'Interceptions Over/Under',
        'Fumble Recoveries Over/Under', 'Defensive Touchdowns Over/Under', 'Tackles Over/Under'
      ],
      'Any Player': [
    ...
    'Team Props': {
      'All': [
        'Team Total Points Over/Under', 'Team Total Touchdowns Over/Under', 'Team Total Field Goals Over/Under',
        'Team to Score First', 'Team to Score Last', 'Team Total Turnovers Over/Under', 
        'Team Total Sacks Over/Under', 'Team Total Tackles Over/Under'
      ]
    },
    'Game Props': {
      'All': [
        'Total Touchdowns Over/Under', 'Total Field Goals Over/Under', 'Total Turnovers Over/Under',
        'Total Sacks Over/Under', 'First Score Type', 'Last Score Type',
        'Points Scored Even/Odd', 'Longest Touchdown Over/Under', 'First Quarter Points Over/Under',
        'First Half Points Over/Under', 'Second Half Points Over/Under', 'Times Tied Over/Under'
      ]
    }
  },
  NCAAF: {
    ...
    'Player Props': {
      'Quarterback': [
        'Passing Yards Over/Under', 'Passing Touchdowns Over/Under', 'Interceptions Over/Under',
        'Completions Over/Under', 'Rushing Yards Over/Under', 'Rushing Touchdowns Over/Under'
      ],
      'Running Back': [
        'Rushing Yards Over/Under', 'Rushing Touchdowns Over/Under', 'Rushing Attempts Over/Under',
        'Receptions Over/Under', 'Receiving Yards Over/Under'
      ],
      'Wide Receiver': [
        'Receiving Yards Over/Under', 'Receptions Over/Under', 'Receiving Touchdowns Over/Under',
      ...
      'Kicker/Defense': [
        'Kicking Points Over/Under', 'Field Goals Made Over/Under', 'Sacks Over/Under',
    ...
    'Team Props': {
      'All': [
        'Team Total Points Over/Under', 'Team Total Touchdowns Over/Under', 'Team Total Field Goals Over/Under',
        'Team to Score First', 'Team Total Turnovers Over/Under'
      ]
    },
    'Game Props': {
      'All': [
        'Total Touchdowns Over/Under', 'Total Field Goals Over/Under', 'Total Turnovers Over/Under',
        'First Score Type', 'Points Scored Even/Odd',
        'First Quarter Points Over/Under', 'First Half Points Over/Under'
      ]
    }
  },
  NBA: {
    ...
    'Player Props': {
      'Scoring': [
        'Points Over/Under', 'Field Goals Made Over/Under', 'Field Goal Attempts Over/Under',
        'Three-Pointers Made Over/Under', 'Three-Point Attempts Over/Under', 'Free Throws Made Over/Under',
        'Free Throw Attempts Over/Under'
      ],
      'Rebounding': [
        'Total Rebounds Over/Under', 'Offensive Rebounds Over/Under', 'Defensive Rebounds Over/Under'
      ],
      'Playmaking': [
        'Assists Over/Under', 'Turnovers Over/Under', 'Steals Over/Under', 'Blocks Over/Under'
      ],
      'Combo Props': [
        'Points + Rebounds Over/Under', 'Points + Assists Over/Under', 'Rebounds + Assists Over/Under',
        'Points + Rebounds + Assists Over/Under', 'Blocks + Steals Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Points Over/Under', 'Team Total Rebounds Over/Under', 'Team Total Assists Over/Under',
        'Team Total Three-Pointers Over/Under', 'Team Total Turnovers Over/Under', 'Team to Score First',
        'Team Highest Scoring Quarter'
      ]
    },
    'Game Props': {
      'All': [
        'Total Rebounds Over/Under', 'Total Assists Over/Under', 'Total Three-Pointers Over/Under',
        'Total Turnovers Over/Under', 'Total Steals Over/Under', 'Total Blocks Over/Under',
        'Highest Scoring Quarter', 'Lowest Scoring Quarter',
        'First Quarter Points Over/Under', 'First Half Points Over/Under', 'Second Half Points Over/Under'
      ]
    }
  },
  NCAAB: {
    ...
    'Player Props': {
      'Scoring': [
        'Points Over/Under', 'Field Goals Made Over/Under', 'Three-Pointers Made Over/Under',
      ...
      'Combo Props': [
        'Points + Rebounds Over/Under', 'Points + Assists Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Points Over/Under', 'Team Total Rebounds Over/Under', 'Team Total Assists Over/Under',
        'Team Total Three-Pointers Over/Under', 'Team to Score First'
      ]
    },
    'Game Props': {
      'All': [
        'Total Rebounds Over/Under', 'Total Assists Over/Under', 'Total Three-Pointers Over/Under',
        'First Half Points Over/Under', 'Second Half Points Over/Under'
      ]
    }
  },
  NHL: {
    ...
    'Player Props': {
      'Skaters': [
        'Goals Over/Under', 'Assists Over/Under', 'Points Over/Under', 'Shots on Goal Over/Under',
        'Hits Over/Under', 'Blocked Shots Over/Under', 'Penalty Minutes Over/Under',
        'Power Play Points Over/Under', 'Time on Ice Over/Under', 'Faceoff Wins Over/Under'
      ],
      'Goalies': [
        'Saves Over/Under', 'Goals Against Over/Under', 'Save Percentage Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Goals Over/Under', 'Team Total Shots Over/Under', 'Team Total Hits Over/Under',
        'Team Total Penalty Minutes Over/Under', 'Team to Score First', 'Team to Score Last',
        'Team Power Play Goals Over/Under', 'Team Short-Handed Goals Over/Under'
      ]
    },
    'Game Props': {
      'All': [
        'Total Shots on Goal Over/Under', 'Total Hits Over/Under', 'Total Penalty Minutes Over/Under',
        'Total Power Plays Over/Under', 'Goals Scored Even/Odd', 'First Goal Time Over/Under', 
        'First Period Goals Over/Under', 'Second Period Goals Over/Under', 'Third Period Goals Over/Under'
      ]
    }
  },
  'Champions League': {
    ...
    'Player Props': {
      'Forwards': [
        'Goals Over/Under', 'Shots on Target Over/Under', 'Shots Over/Under', 'Assists Over/Under',
        'Fouls Committed Over/Under', 'Cards Received Over/Under'
      ],
      'Midfielders': [
        'Passes Completed Over/Under', 'Pass Completion % Over/Under', 'Tackles Over/Under',
        'Assists Over/Under', 'Shots Over/Under', 'Fouls Committed Over/Under', 'Cards Received Over/Under'
      ],
      'Defenders': [
        'Tackles Over/Under', 'Clearances Over/Under', 'Blocks Over/Under', 'Interceptions Over/Under',
        'Fouls Committed Over/Under', 'Cards Received Over/Under'
      ],
      'Goalkeepers': [
        'Saves Over/Under', 'Goals Conceded Over/Under', 'Punches/Catches Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Goals Over/Under', 'Team Total Shots Over/Under', 'Team Total Shots on Target Over/Under',
        'Team Total Corners Over/Under', 'Team Total Cards Over/Under', 'Team to Score First',
        'Team to Score Last', 'Team Total Fouls Over/Under', 'Team Total Offsides Over/Under'
      ]
    },
    'Game Props': {
      'All': [
        'Total Shots Over/Under', 'Total Shots on Target Over/Under', 'Total Corners Over/Under',
        'Total Cards Over/Under', 'Total Fouls Over/Under', 'Total Offsides Over/Under',
        'Goals Scored Even/Odd', 'First Goal Time Over/Under', 'First Half Goals Over/Under',
  ...
  MLS: {
    ...
    'Player Props': {
      'Forwards': [
        'Goals Over/Under', 'Shots on Target Over/Under', 'Assists Over/Under'
      ],
      'Midfielders': [
        'Passes Completed Over/Under', 'Tackles Over/Under', 'Assists Over/Under', 'Shots Over/Under'
      ],
      'Defenders': [
        'Tackles Over/Under', 'Clearances Over/Under', 'Blocks Over/Under', 'Interceptions Over/Under'
      ],
      'Goalkeepers': [
        'Saves Over/Under', 'Goals Conceded Over/Under'
      ]
    },
    'Team Props': {
      'All': [
        'Team Total Goals Over/Under', 'Team Total Shots Over/Under', 'Team Total Corners Over/Under',
        'Team Total Cards Over/Under', 'Team to Score First'
      ]
    },
    'Game Props': {
      'All': [
        'Total Shots Over/Under', 'Total Corners Over/Under', 'Total Cards Over/Under',
        'Goals Scored Even/Odd', 'First Half Goals Over/Under', 'Second Half Goals Over/Under'
      ]
    }
  }
};

export default function UniversalGameCard({ game, league, onOddsClick = () => {}, selectedBets = [] }: UniversalGameCardProps) {
  ...
  const getSelectionLabel = (oddid: string): string => {
    // ============ MAIN LINES ============
    if (oddid.includes('points-home-game-ml-home') || oddid.includes('-ml-home')) return game.home_team;
    if (oddid.includes('points-away-game-ml-away') || oddid.includes('-ml-away')) return game.away_team;
    if (oddid.includes('points-all-game-ml-draw') || oddid.includes('-ml-draw')) return 'Draw';
    if (oddid.includes('points-home-game-sp-home') || oddid.includes('points-home-game-rl-home') || oddid.includes('-sp-home') || oddid.includes('-rl-home')) {
      return `${game.home_team}`;
    }
    if (oddid.includes('points-away-game-sp-away') || oddid.includes('points-away-game-rl-away') || oddid.includes('-sp-away') || oddid.includes('-rl-away')) {
  ...
  const handleBetClick = (odd: DatabaseOdds) => {
    ...
    const oddsValue = odd.fanduelodds || odd.draftkingsodds || odd.espnbetodds || 
                     odd.ceasarsodds || odd.mgmodds || odd.fanaticsodds || odd.bookodds || 0;
    ...
    const fetchOdds = async () => {
      try {
        ...
        console.log('🎯 Odds fetched:', {
          ...
          oddidSamples: data?.slice(0, 10).map(odd => ({
            id: odd.id,
            oddid: odd.oddid,
  ...
  const categorizeOdds = () => {
    ...
    odds.forEach((odd, index) => {
      ...
      try {
        ...
        if (oddid.includes('points-home-game-ml-home') || oddid.includes('points-away-game-ml-away') || 
        ...
        else if (oddid.includes('points-home-game-sp-home') || oddid.includes('points-away-game-sp-away')) {
          category = 'Main Lines';
          subcategory = 'All';
          console.log(`✅ Main Line (Spread): ${odd.oddid}`);
        }
        // Totals/Over-Under (game level only) - exact patterns from games-page.md
        else if ((oddid.includes('points-all-game-ou-over') || oddid.includes('points-all-game-ou-under')) && 
                 !oddid.match(/\d{4,}/)) {
          category = 'Main Lines';
          subcategory = 'All';
        ...
        // Examples: batting_triples-MATT_MCLAIN_1_MLB-game-ou-under, fantasyScore-NOELVI_MARTE_1_MLB-game-ou-under
        else if (oddid.match(/-[A-Z_]+_1_[A-Z]+-game-/) || 
          ...
          // Football specific
            ...
            if (oddid.includes('passing_') || oddid.includes('quarterback') || oddid.includes('qb')) {
            ...
            } else if (oddid.includes('kicking_') || oddid.includes('fieldgoals_') || oddid.includes('defense_')) {
          ...
          // Basketball specific
            ...
            if (oddid.includes('points-') || oddid.includes('fieldgoals_') || oddid.includes('threepointers_') || 
            ...
            } else if (oddid.includes('assists-') || oddid.includes('steals-') || oddid.includes('blocks-') || 
                      oddid.includes('turnovers-')) {
              subcategory = 'Playmaking';
              console.log(`🏀 NBA Playmaking prop: ${odd.oddid}`);
            } else if (oddid.includes('+') || oddid.includes('double') || oddid.includes('combo') || 
          ...
          // Hockey specific
            ...
            if (oddid.includes('saves-') || oddid.includes('goalsagainst') || oddid.includes('shutout') || 
                oddid.includes('win-')) {
              subcategory = 'Goalies';
          ...
          // Soccer specific
            ...
            } else if (oddid.includes('passes') || oddid.includes('assists-') || oddid.includes('mid')) {
              subcategory = 'Midfielders';
              console.log(`⚽ Soccer Midfielder prop: ${odd.oddid}`);
            } else if (oddid.includes('tackles-') || oddid.includes('clearances') || oddid.includes('blocks-') || 
                      oddid.includes('interceptions')) {
              subcategory = 'Defenders';
              console.log(`⚽ Soccer Defender prop: ${odd.oddid}`);
            } else if (oddid.includes('saves-') || oddid.includes('goalsconceded') || oddid.includes('cleansheet')) {
        ...
        else if ((oddid.includes('points-home-game-ou-') || oddid.includes('points-away-game-ou-') ||
                  oddid.includes('batting_homeruns-home-game-') || oddid.includes('batting_homeruns-away-game-') ||
                  oddid.includes('touchdowns-home-game-') || oddid.includes('touchdowns-away-game-') ||
                  oddid.includes('corners-home-game-') || oddid.includes('corners-away-game-') ||
                  oddid.includes('shots-home-game-') || oddid.includes('shots-away-game-') ||
                  oddid.includes('firsttoscore-home-game-') || oddid.includes('firsttoscore-away-game-') ||
                  oddid.includes('lasttoscore-home-game-') || oddid.includes('lasttoscore-away-game-')) &&
                 !oddid.match(/\d{4,}/)) {
          category = 'Team Props';
          subcategory = 'All';
        }
        ...
        else if ((oddid.includes('batting_homeruns-all-game-') || oddid.includes('touchdowns-all-game-') ||
                  oddid.includes('corners-all-game-') || oddid.includes('shots-all-game-') ||
                  oddid.includes('overtime-all-game-') || oddid.includes('extratime-all-game-') ||
                  oddid.includes('penaltyshootout-all-game-') || oddid.includes('bothteamstoscore-all-game-') ||
                  oddid.includes('firstscore-all-game-') || oddid.includes('lastscore-all-game-') ||
                  oddid.includes('points-all-game-eo-') || oddid.includes('firstgoaltime-all-game-') ||
                  oddid.includes('longesttouchdown-all-game-') || oddid.includes('timestied-all-game-') ||
                  // Period/Inning specific props
                  oddid.includes('points-all-1q-') || oddid.includes('points-all-1h-') || 
                  oddid.includes('points-all-2h-') || oddid.includes('points-all-1p-') ||
                  oddid.includes('points-all-2p-') || oddid.includes('points-all-3p-') ||
                  oddid.includes('points-all-1i-') || oddid.includes('points-all-1ix') ||
                  oddid.includes('points-away-1i-') || oddid.includes('points-home-1i-') ||
                  oddid.includes('points-away-1ix') || oddid.includes('points-home-1ix') ||
                  oddid.includes('points-away-1h-') || oddid.includes('points-home-1h-')) && 
    ...
    console.log('📊 Categorization Summary:', {
      ...
      categorized: Object.keys(categorized).reduce((acc, cat) => {
        acc[cat] = Object.keys(categorized[cat] || {}).reduce((subAcc, subCat) => {
  ...
  const displayOdds = useMemo(() => {
    ...
    return currentOdds.filter(odd => {
      ...
      // ============ MAIN LINES MATCHING ============
      if (lowerMarket.includes('moneyline') && (lowerOddid.includes('-ml-') || lowerOddid.includes('points-home-game-ml-') || lowerOddid.includes('points-away-game-ml-'))) return true;
      if (lowerMarket.includes('spread') || lowerMarket.includes('line')) {
        if (lowerOddid.includes('-sp-') || lowerOddid.includes('-rl-') || lowerOddid.includes('points-home-game-sp-') || lowerOddid.includes('points-away-game-sp-')) return true;
      }
      ...
      if (league === 'MLB') {
        ...
        if (lowerMarket.includes('home runs') && (lowerOddid.includes('batting_homeruns') || lowerOddid.includes('batting_homerun'))) return true;
        ...
        if (lowerMarket.includes('total bases') && lowerOddid.includes('batting_totalbases')) return true;
        ...
        if (lowerMarket.includes('stolen bases') && lowerOddid.includes('batting_stolenbases')) return true;
        if (lowerMarket.includes('walks') && (lowerOddid.includes('batting_walks') || lowerOddid.includes('batting_basesonballs'))) return true;
        
        // Pitcher props
        if (lowerMarket.includes('strikeouts') && lowerOddid.includes('pitching_strikeouts')) return true;
        if (lowerMarket.includes('hits allowed') && lowerOddid.includes('pitching_hits')) return true;
        if (lowerMarket.includes('earned runs') && lowerOddid.includes('pitching_earnedruns')) return true;
        if (lowerMarket.includes('walks allowed') && lowerOddid.includes('pitching_walks')) return true;
        if (lowerMarket.includes('home runs allowed') && lowerOddid.includes('pitching_homeruns')) return true;
        if (lowerMarket.includes('pitches thrown') && lowerOddid.includes('pitching_pitches')) return true;
        if (lowerMarket.includes('outs recorded') && lowerOddid.includes('pitching_outs')) return true;
      }
      
      // ============ FOOTBALL SPECIFIC MATCHING ============
      if (league === 'NFL' || league === 'NCAAF') {
        // QB props
        if (lowerMarket.includes('passing yards') && lowerOddid.includes('passing_yards')) return true;
        if (lowerMarket.includes('passing touchdowns') && lowerOddid.includes('passing_touchdowns')) return true;
        if (lowerMarket.includes('interceptions') && lowerOddid.includes('passing_interceptions')) return true;
        if (lowerMarket.includes('completions') && lowerOddid.includes('passing_completions')) return true;
        if (lowerMarket.includes('passing attempts') && lowerOddid.includes('passing_attempts')) return true;
        if (lowerMarket.includes('passer rating') && lowerOddid.includes('passing_passerrating')) return true;
        
        // RB props
        if (lowerMarket.includes('rushing yards') && lowerOddid.includes('rushing_yards')) return true;
        if (lowerMarket.includes('rushing touchdowns') && lowerOddid.includes('rushing_touchdowns')) return true;
        if (lowerMarket.includes('rushing attempts') && lowerOddid.includes('rushing_attempts')) return true;
        if (lowerMarket.includes('rushing + receiving') && lowerOddid.includes('rushing+receiving_yards')) return true;
        
        // WR props
        if (lowerMarket.includes('receiving yards') && lowerOddid.includes('receiving_yards')) return true;
        if (lowerMarket.includes('receptions') && lowerOddid.includes('receiving_receptions')) return true;
        if (lowerMarket.includes('receiving touchdowns') && lowerOddid.includes('receiving_touchdowns')) return true;
        
        // Kicker/Defense props
        if (lowerMarket.includes('kicking points') && lowerOddid.includes('kicking_totalpoints')) return true;
        if (lowerMarket.includes('field goals') && lowerOddid.includes('fieldgoals_made')) return true;
        ...
        // Any player props
        if (lowerMarket.includes('fantasy score') && lowerOddid.includes('fantasyscore')) return true;
      ...
      if (league === 'NBA' || league === 'NCAAB') {
        ...
        if (lowerMarket.includes('points') && lowerOddid.includes('points-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('field goals') && lowerOddid.includes('fieldgoals_')) return true;
        if (lowerMarket.includes('three-pointers') && lowerOddid.includes('threepointers_')) return true;
        if (lowerMarket.includes('free throws') && lowerOddid.includes('freethrows_')) return true;
        
        // Rebounding props
        if (lowerMarket.includes('rebounds') && lowerOddid.includes('rebounds') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('offensive rebounds') && lowerOddid.includes('rebounds_offensive')) return true;
        if (lowerMarket.includes('defensive rebounds') && lowerOddid.includes('rebounds_defensive')) return true;
        
        // Playmaking props
        if (lowerMarket.includes('assists') && lowerOddid.includes('assists-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('steals') && lowerOddid.includes('steals-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('blocks') && lowerOddid.includes('blocks-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
      ...
      if (league === 'NHL') {
        ...
        if (lowerMarket.includes('goals') && lowerOddid.includes('goals-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('assists') && lowerOddid.includes('assists-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('points') && lowerOddid.includes('points-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('shots on goal') && lowerOddid.includes('shots_ongoal')) return true;
        if (lowerMarket.includes('hits') && lowerOddid.includes('hits-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('penalty minutes') && lowerOddid.includes('penaltyminutes')) return true;
        if (lowerMarket.includes('faceoff wins') && lowerOddid.includes('faceoffwins')) return true;
        
        // Goalie props
        if (lowerMarket.includes('saves') && lowerOddid.includes('saves-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('goals against') && lowerOddid.includes('goalsagainst')) return true;
        if (lowerMarket.includes('save percentage') && lowerOddid.includes('savepercentage')) return true;
      }
      ...
      if (league === 'Champions League' || league === 'MLS') {
        ...
        if (lowerMarket.includes('goals') && lowerOddid.includes('goals-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('shots') && lowerOddid.includes('shots-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        if (lowerMarket.includes('assists') && lowerOddid.includes('assists-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        
        // Midfielder props
        if (lowerMarket.includes('passes') && lowerOddid.includes('passes')) return true;
        if (lowerMarket.includes('tackles') && lowerOddid.includes('tackles-') && lowerOddid.match(/-[A-Z_]+_1_[A-Z]+-game-/)) return true;
        
        // Defender props
        if (lowerMarket.includes('clearances') && lowerOddid.includes('clearances')) return true;
        if (lowerMarket.includes('interceptions') && lowerOddid.includes('interceptions')) return true;
      ...
      // ============ TEAM PROPS MATCHING ============
      if (lowerMarket.includes('team total') && (lowerOddid.includes('-home-game-') || lowerOddid.includes('-away-game-'))) return true;
      if (lowerMarket.includes('team to score') && (lowerOddid.includes('firsttoscore') || lowerOddid.includes('lasttoscore'))) return true;
  ...
  useEffect(() => {
    ...
    if (availableMarkets.length > 0 && (!activeMarket || !availableMarkets.includes(activeMarket))) {
  ...
  const renderMainLinesDisplay = () => {
    ...
    const moneylineOdds = uniqueOddsArray.filter(odd => {
      if (!odd.oddid) return false;
      return odd.oddid === 'points-home-game-ml-home' || 
    ...
    const spreadOdds = uniqueOddsArray.filter(odd => {
      if (!odd.oddid) return false;
      return odd.oddid === 'points-home-game-sp-home' || 
             odd.oddid === 'points-away-game-sp-away';
    });
    
    const totalOdds = uniqueOddsArray.filter(odd => {
      if (!odd.oddid) return false;
      return odd.oddid === 'points-all-game-ou-over' || 
             odd.oddid === 'points-all-game-ou-under';
    });
            ...
            <div className="grid grid-cols-2 gap-2">
              {moneylineOdds.map((odd) => {
                ...
                const isSelected = selectedBets.some(bet => 
                  bet.gameId === game.id && bet.sportsbook === odd.sportsbook
                );
                
                const team = odd.oddid?.includes('-home') ? game.home_team : 
                           odd.oddid?.includes('-away') ? game.away_team : 'Draw';
                ...
                return (
                  <button
                    ...
                    className={`
                      px-3 py-2 rounded-lg font-semibold border border-slate-200 transition-all shadow-sm
                      ${isSelected 
                        ? 'bg-gradient-to-b from-blue-600 to-blue-700 text-white shadow-md' 
                        : isGameStarted
                          ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                          : 'bg-gradient-to-b from-white to-purple-25 text-slate-800 hover:from-purple-100 hover:to-purple-200 hover:shadow-md cursor-pointer'
                      }
                    `}
                  >
                    <div className="text-center">
                      <div className="text-sm font-bold text-purple-700">{team}</div>
                      <div className="text-lg font-bold font-mono">{formatOdds(oddsValue)}</div>
                    </div>
                  </button>
                );
              })}
  ...
  const getPropDisplayName = (oddid: string): string => {
    ...
    if (lowerOddid.includes('batting_basesonballs') || lowerOddid.includes('batting_walks')) return 'Walks';
    ...
    if (lowerOddid.includes('pitching_basesonballs') || lowerOddid.includes('pitching_walks')) return 'Walks Allowed';
    if (lowerOddid.includes('pitching_homerunsallowed')) return 'HRs Allowed';
    if (lowerOddid.includes('pitching_pitchesthrown') || lowerOddid.includes('pitching_pitches')) return 'Pitches Thrown';
    ...
    if (lowerOddid.includes('rebounds') && !lowerOddid.includes('offensive') && !lowerOddid.includes('defensive')) return 'Total Rebounds';
    ...
    if (lowerOddid.includes('firstscore') && lowerOddid.includes('-all-game-')) return 'First Score Type';
    if (lowerOddid.includes('lastscore') && lowerOddid.includes('-all-game-')) return 'Last Score Type';
  ...
  const getPlayerName = (oddid: string): string => {
    ...
    if (playerId) {
      ...
      if (oddid.includes('batting_') || oddid.includes('pitching_')) {
        return oddid.includes('batting_') ? `Batter #${playerId.slice(-3)}` : `Pitcher #${playerId.slice(-3)}`;
      } else if (oddid.includes('passing_') || oddid.includes('rushing_') || oddid.includes('receiving_')) {
      ...
      } else if (oddid.includes('goals-') || oddid.includes('assists-') || oddid.includes('saves-')) {
        return oddid.includes('saves-') ? `Goalie #${playerId.slice(-3)}` : `Player #${playerId.slice(-3)}`;
      }
  ...
  const renderPropsDisplay = () => {
    ...
    const groupedProps: { [key: string]: { over?: DatabaseOdds; under?: DatabaseOdds; base: string; line?: string } } = {};
    ...
    deduplicatedOdds.forEach((odd, index) => {
      ...
      if (index < 5) { // Debug first few props
        console.log(`🎯 Processing prop ${index + 1}: ${odd.oddid} -> base: ${baseId}, isOver: ${isOver}, isUnder: ${isUnder}`);
      }
      ...
      <div className="space-y-1">
        {Object.entries(groupedProps).length === 0 ? (
          <div className="text-center py-4 text-slate-500">
            ...
            <p className="text-xs mt-1">Total display odds: {displayOdds.length}</p>
          </div>
        ) : (
          <div className="max-h-96 overflow-y-auto space-y-1 pr-1">
            ...
            const isPlayerProp = group.base.match(/-[A-Z_]+_1_[A-Z]+-game$/) || group.base.match(/\d{4,}/);
            const isTeamProp = group.base.includes('-home-game') || group.base.includes('-away-game');
            ...
            const overOdds = group.over ? (group.over.fanduelodds || group.over.draftkingsodds || group.over.espnbetodds || 
                                         group.over.ceasarsodds || group.over.mgmodds || group.over.fanaticsodds || group.over.bookodds || 0) : null;
            const underOdds = group.under ? (group.under.fanduelodds || group.under.draftkingsodds || group.under.espnbetodds || 
                                           group.under.ceasarsodds || group.under.mgmodds || group.under.fanaticsodds || group.under.bookodds || 0) : null;

            return (
              <div key={key} className="flex items-center justify-between py-2 px-3 bg-gradient-to-r from-slate-50 to-slate-25 rounded-lg hover:from-blue-50 hover:to-indigo-25 transition-all border border-slate-200 hover:border-blue-300 hover:shadow-sm">
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-semibold text-slate-900 truncate">
                    {playerOrTeam ? (
                      <span className="text-blue-700 font-bold">{playerOrTeam}</span>
                    ) : (
                  ...
                  <div className="text-xs text-slate-500 mt-0.5 flex items-center space-x-2">
                    ...
                    {group.line && (
                      <>
                        ...
                        <span>Line: <span className="font-mono">{group.line}</span></span>
                      </>
                    )}
                  </div>
                </div>
              ...
              <div className="flex items-center space-x-2 ml-4">
                ...
                {group.over && overOdds && (
                  <button
                    ...
                    disabled={isGameStarted}
                    className={`
                      px-2 py-1.5 rounded-md text-xs font-bold border transition-all min-w-[60px]
                      ${selectedBets.some(bet => bet.gameId === game.id && bet.sportsbook === group.over!.sportsbook)
                        ? 'bg-gradient-to-b from-blue-600 to-blue-700 text-white border-blue-600 shadow-md' 
                        : isGameStarted
                          ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
                          : 'bg-gradient-to-b from-white to-green-50 text-slate-700 border-green-300 hover:from-green-50 hover:to-green-100 hover:border-green-400 hover:shadow-md cursor-pointer'
                      }
                    `}
                  >
                    <div className="text-center">
                      <div className="text-xs font-medium text-green-600 mb-0.5">O</div>
                ...
                {group.under && underOdds && (
                  <button
                    ...
                    className={`
                      px-2 py-1.5 rounded-md text-xs font-bold border transition-all min-w-[60px]
                      ${selectedBets.some(bet => bet.gameId === game.id && bet.sportsbook === group.under!.sportsbook)
                        ? 'bg-gradient-to-b from-blue-600 to-blue-700 text-white border-blue-600 shadow-md' 
                        : isGameStarted
                          ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
                          : 'bg-gradient-to-b from-white to-red-50 text-slate-700 border-red-300 hover:from-red-50 hover:to-red-100 hover:border-red-400 hover:shadow-md cursor-pointer'
                      }
                    `}
                  >
                    <div className="text-center">
                      <div className="text-xs font-medium text-red-600 mb-0.5">U</div>
  ...
  return (
    <div className="bg-gradient-to-br from-white to-slate-50 rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-sm font-semibold text-slate-800">
              <span className="text-blue-700">{game.away_team}</span> @ <span className="text-indigo-700">{game.home_team}</span>
            </span>
      ...
      <div className="p-4">
        {/* Category Tabs */}
        <div className="flex space-x-1 mb-4 bg-gradient-to-r from-slate-100 to-slate-50 p-1 rounded-lg border border-slate-200">
          {Object.keys(tabStructure || {}).map((category) => (
            <button
              ...
              className={`
                px-3 py-2 text-sm font-medium rounded-md transition-all flex-1
                ${activeCategory === category
                  ? 'bg-gradient-to-b from-white to-blue-50 text-blue-700 shadow-md border border-blue-200'
        ...
        {/* Subcategory Tabs */}
        {!Array.isArray(tabStructure?.[activeCategory]) && Object.keys(tabStructure?.[activeCategory] || {}).length > 1 && (
              ...
              <button
                ...
                className={`
                  ...
                  ${activeSubcategory === subcategory
                    ...
                    : 'border-transparent text-slate-600 hover:text-slate-900 hover:border-blue-300 hover:bg-slate-50'
                  }
                `}
              >
                {subcategory}
