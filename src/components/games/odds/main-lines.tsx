...
export default function MainLines({
  ...
  return (
    <div className="space-y-2 sm:space-y-3">
      ...
      <div className="hidden xs:grid grid-cols-3 gap-2 sm:gap-3">
        <div className="text-center text-xs font-medium text-slate-500 uppercase tracking-wide truncate">
          {headers.moneyline}
        </div>
        <div className="text-center text-xs font-medium text-slate-500 uppercase tracking-wide truncate">
          {headers.spread}
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
        ...
        <div className="text-center">
          {moneylineOdds?.away ? (
            ...
            <div className="text-xs text-slate-400 py-2">N/A</div>
          )}
        </div>
