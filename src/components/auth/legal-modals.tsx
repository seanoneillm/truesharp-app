          ...
          <div className="prose prose-sm max-w-none">
            <div className="space-y-6 text-sm text-slate-700">
              <section>
                ...
                <p>
                  By accessing and using TrueSharp (&ldquo;the Service&rdquo;), you accept and agree
                  to be bound by the terms and provision of this agreement.
                </p>
              </section>

              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">2. Age Requirement</h3>
                <p>
                  You must be at least 21 years old to use TrueSharp. By using our service, you
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">
                  3. Sports Betting Information
                </h3>
                <p>
                  TrueSharp provides sports betting analysis, predictions, and information. All
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">5. Disclaimer</h3>
                <p>
                  TrueSharp does not guarantee the accuracy of any predictions or analysis. Sports
                  betting involves risk, and you should never bet more than you can afford to lose.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  TrueSharp shall not be liable for any direct, indirect, incidental, special, or
                  consequential damages resulting from the use of our service.
                </p>
              </section>

              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">7. Termination</h3>
                <p>
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">8. Changes to Terms</h3>
                <p>
        ...
        <DialogContent className="max-h-[80vh] max-w-4xl overflow-y-auto">
          ...
          <div className="prose prose-sm max-w-none">
            <div className="space-y-6 text-sm text-slate-700">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p>
                      ...
                      account, including your email address, username, and age verification.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-slate-800">Usage Information</h4>
                    <p>
                      We collect information about how you use our service, including your
                      interactions with content, features used, and time spent on the platform.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">4. Data Security</h3>
                <p>
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">5. Data Retention</h3>
                <p>
                  We retain your personal information for as long as necessary to provide you with
                  our services and as described in this Privacy Policy.
                </p>
              </section>

              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">6. Your Rights</h3>
                <ul className="list-inside list-disc space-y-2">
              ...
              <section>
                <h3 className="mb-3 text-base font-semibold text-slate-900">9. Contact Us</h3>
                <p>
                  If you have any questions about this Privacy Policy, please contact us at
                  privacy@truesharp.com.
                </p>
              </section>
