...
export function TopBar({ className, mobileMenuButton }: TopBarProps) {
  return (
    <header 
      className={cn(
        "sticky top-0 z-30 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white/80 backdrop-blur-sm px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8",
        className
      )}
    >
      {/* Mobile menu button */}
