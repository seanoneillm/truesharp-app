    ...
    <header className="relative z-50 bg-white shadow-sm">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4">
          ...
          <Link
            href="/signup"
            className="rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-500"
          >
            Get started
          </Link>
        </div>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  ...
                  <Link
                    href="/signup"
                    className="mt-4 block rounded-md bg-blue-600 px-3.5 py-2.5 text-center text-base font-semibold text-white shadow-sm transition-colors hover:bg-blue-500"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Get started
                  </Link>
