...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className={cn('relative w-full rounded-lg bg-background shadow-lg', sizes[size], className)}
...
const ModalFooter: React.FC<{
  ...
  return (
    <div className={cn('flex items-center justify-end space-x-2 border-t p-6', className)}>
      {children}
    </div>
  )
}
