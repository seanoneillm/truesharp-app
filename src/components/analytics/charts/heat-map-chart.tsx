    ...
    return (
      <Card className="p-6">
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-semibold mb-2">Performance Heat Map</h3>
    ...
    <Card className="p-6">
        ...
        <div className="grid grid-cols-25 gap-1">
          ...
          {days.map(day => (
            <React.Fragment key={day}>
              <div className="text-xs text-right text-muted-foreground p-1 flex items-center justify-end">
                {day}
              </div>
              {hours.map(hour => {
                ...
                return (
                  <div
                    key={`${day}-${hour}`}
                    className="aspect-square border border-gray-200 cursor-pointer hover:border-gray-400 transition-colors rounded-sm"
                    style={{
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-muted-foreground">
          Range: {minValue.toFixed(2)} to {maxValue.toFixed(2)}{metric === 'profit' ? '$' : '%'}
        </div>
      </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <p className="font-semibold">
                {selectedCell.value.toFixed(2)}{metric === 'profit' ? '$' : '%'}
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className={`font-semibold ${selectedCell.value > 0 ? 'text-green-600' : 'text-red-600'}`}>
