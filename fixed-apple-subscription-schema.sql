-- Fixed SQL for existing pro_subscriptions table
-- Execute this in Supabase SQL editor

-- Add missing Apple-specific fields (only the ones not already present)
...
CREATE INDEX IF NOT EXISTS idx_pro_subscriptions_transaction_validation_status 
...
-- Updated function for modern App Store Server API validation (compatible with existing table)
...
-- Create missing trigger function if it doesn't exist
