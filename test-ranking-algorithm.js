...
testStrategies.forEach((strategy, index) => {
  ...
  console.log(`  Win Rate Score (25%): ${winRateScore.toFixed(1)} (Rate: ${(strategy.win_rate * 100).toFixed(1)}%)`);
...
rankedStrategies.forEach((strategy, index) => {
  ...
  console.log(`  ROI: ${strategy.roi_percentage}% | Win Rate: ${(strategy.win_rate * 100).toFixed(1)}%`);
